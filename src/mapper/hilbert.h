...
// nDims = 2,  nBits = 10?
bitmask_t hilbert_c2i2(unsigned nDims, unsigned nBits, bitmask_t const coord[]);
...
static int hilbert_cmp_work(unsigned nDims, unsigned nBytes, unsigned nBits, unsigned max, unsigned y, char const* c1, char const* c2, unsigned rotation, bitmask_t bits, bitmask_t index, BitReader getBits);
